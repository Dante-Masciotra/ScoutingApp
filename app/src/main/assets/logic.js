    ...
    if(document.getElementsByName("position")[0].checked == true){
     ...
     if(document.getElementsByName("Colour")[0].checked == true){
        ...
        if(document.getElementsByName("Y/n")[0].checked == true){
         ...
         localStorage.setItem("Team Number"+(localStorage.length/19), teamNumber)
        localStorage.setItem("Match Number"+((localStorage.length-1)/19), matchNumber)
...
function load(){
   ...
   for(i=0; i<(localStorage.length/19); i++){
   keyNum.push((localStorage.length/19)-(i+1));
console.log[i]
